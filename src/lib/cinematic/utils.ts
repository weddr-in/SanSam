...
export function getPositionClasses(position: Perspective['position']): string {
    switch (position) {
        case 'top':
            return 'top-20 left-1/2 -translate-x-1/2 max-md:top-[20vh] max-md:px-4 w-full';
        case 'top-left':
            return 'top-20 left-20 max-md:top-[15vh] max-md:left-6 max-md:right-6 text-left';
        case 'left':
            return 'left-20 top-1/2 -translate-y-1/2 max-md:left-6 max-md:right-6 max-md:translate-y-0 max-md:top-[30vh] text-left';
        case 'center':
            return 'top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-4';
        case 'top-right':
            return 'top-20 right-20 max-md:top-[15vh] max-md:right-6 max-md:left-6 flex flex-col items-end max-md:items-end text-right';
        case 'bottom':
            return 'bottom-20 left-1/2 -translate-x-1/2 text-center max-md:bottom-[15vh] max-md:px-4 w-full';
        case 'bottom-left':
            return 'bottom-20 left-20 max-md:bottom-[15vh] max-md:left-6 max-md:right-6 flex flex-col items-start text-left';
        case 'bottom-right':
            return 'bottom-20 right-20 max-md:bottom-[15vh] max-md:right-6 max-md:left-6 flex flex-col items-end text-right';
        default:
